// Example server.js file for your Railway deployment
// This shows how to wire up both scraper endpoints

const express = require('express');
const { runJobScraper, runGeneralJobScraper } = require('./job-scraper/scraper');
